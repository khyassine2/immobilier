...
import { deleteImo } from "../../projet/imobS";
            ...
            <div className="row">
                ...
                <div className="col-8 ">
                       ...
                       <div className="row my-4">
                            ...
                            <div className="col-2 p-0"><button><Link  style={{textDecoration:"none",color:"black",padding:"20px"}} to="/admin/annonces/create">Creer</Link></button></div>
                       </div>
                       ...
                       <div className="row my-4 " key={i}>
                                ...
                                <div className="col-3 my-5">
                                    <button><Link  style={{textDecoration:"none",color:"black",padding:"20px"}} to={"/admin/annonces/edit/"+e.id}>Editer</Link></button><br/><br/>
